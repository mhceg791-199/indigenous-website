  ...
  return (
    <footer className="grid md:grid-cols-10 grid-cols-1 px-5 py-3 gap-5 bg-mainColor text-lightColor">
      ...
      <div className="md:col-span-5 flex flex-col items-center md:items-start justify-center">
        ...
        <nav className="flexx flex-wrap justify-center md:justify-start gap-1 mt-1 pl-2 md:pl-0 text-center font-semibold">
          {linksBottom.map((l, i) => (
            <Link key={i} to={l.to} className="me-1 hover:opacity-80 w-2">
        ...
        <p className="text-sm mt-2 text-center md:text-left">
          © 2025 Indigenous Mosaic, All rights reserved
        </p>
      </div>
